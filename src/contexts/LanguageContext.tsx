...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'portfolio.stats.types': 'Vehicle Types',
    'portfolio.stats.vehicles': 'Vehicles',
    'portfolio.stats.certified': 'Certified',
    'portfolio.stats.tracked': 'Tracked',

    // Fleet units
    'portfolio.fleet.badge': 'Our Fleet',
    'portfolio.fleet.title': 'Fleet & Specifications',
    'portfolio.fleet.desc': 'We operate a diverse fleet of vehicles to meet every delivery need — from compact cargo vans to full-size 26-foot box trucks.',
    'portfolio.spec.type': 'Type',
    'portfolio.spec.cargo': 'Cargo Space',
    'portfolio.spec.payload': 'Payload',
    'portfolio.spec.engine': 'Engine',
    'portfolio.spec.features': 'Features',

    'portfolio.unit.cab.name': 'Truck Cab',
    'portfolio.unit.cab.desc': 'Heavy-duty Freightliner cab unit for long-haul and regional towing operations, offering power and reliability.',
    'portfolio.unit.cab.type': 'Semi Tractor',
    'portfolio.unit.cab.payload': '40,000 lbs',
    'portfolio.unit.cab.engine': 'Detroit Diesel',
    'portfolio.unit.cab.features': 'Air Ride, GPS, ELD',

    'portfolio.unit.van.name': 'Cargo Van',
    'portfolio.unit.van.desc': 'Versatile cargo van ideal for last-mile deliveries, small freight, and time-sensitive urban routes.',
    'portfolio.unit.van.type': 'Cargo Van',
    'portfolio.unit.van.cargo': '450 cu ft',
    'portfolio.unit.van.payload': '3,500 lbs',
    'portfolio.unit.van.features': 'GPS, Rear Camera, Shelving',

    'portfolio.unit.16ft.name': '16 ft Box Truck',
    'portfolio.unit.16ft.desc': 'Mid-size box truck perfect for medium freight loads, commercial moves, and multi-stop routes.',
    'portfolio.unit.16ft.type': '16 ft Box Truck',
    'portfolio.unit.16ft.cargo': '900 cu ft',
    'portfolio.unit.16ft.payload': '5,000 lbs',
    'portfolio.unit.16ft.features': 'Lift Gate, GPS, Ramp',

    'portfolio.unit.26ft.name': '26 ft Box Truck',
    'portfolio.unit.26ft.desc': 'Our workhorse — full-size 26-foot box trucks for large freight, contracted logistics, and high-volume operations.',
    'portfolio.unit.26ft.type': '26 ft Box Truck',
    'portfolio.unit.26ft.cargo': '1,800 cu ft',
    'portfolio.unit.26ft.payload': '10,000 lbs',
    'portfolio.unit.26ft.features': 'Lift Gate, GPS, Climate Ctrl',
  ...
  es: {
    ...
    'portfolio.stats.types': 'Tipos de Vehículo',
    'portfolio.stats.vehicles': 'Vehículos',
    'portfolio.stats.certified': 'Certificado',
    'portfolio.stats.tracked': 'Rastreado',

    // Fleet units
    'portfolio.fleet.badge': 'Nuestra Flota',
    'portfolio.fleet.title': 'Flota y Especificaciones',
    'portfolio.fleet.desc': 'Operamos una flota diversa de vehículos para satisfacer cada necesidad de entrega — desde vans de carga compactas hasta camiones de 26 pies.',
    'portfolio.spec.type': 'Tipo',
    'portfolio.spec.cargo': 'Espacio de Carga',
    'portfolio.spec.payload': 'Carga Útil',
    'portfolio.spec.engine': 'Motor',
    'portfolio.spec.features': 'Características',

    'portfolio.unit.cab.name': 'Cabina de Camión',
    'portfolio.unit.cab.desc': 'Unidad de cabina Freightliner de servicio pesado para operaciones de remolque regionales y de larga distancia, ofreciendo potencia y confiabilidad.',
    'portfolio.unit.cab.type': 'Semi Tractor',
    'portfolio.unit.cab.payload': '40,000 lbs',
    'portfolio.unit.cab.engine': 'Detroit Diesel',
    'portfolio.unit.cab.features': 'Air Ride, GPS, ELD',
    ...
    'portfolio.unit.van.name': 'Cargo Van',
    'portfolio.unit.van.desc': 'Van de carga versátil ideal para entregas de última milla, carga pequeña y rutas urbanas sensibles al tiempo.',
    'portfolio.unit.van.type': 'Cargo Van',
    'portfolio.unit.van.cargo': '450 cu ft',
    'portfolio.unit.van.payload': '3,500 lbs',
    'portfolio.unit.van.features': 'GPS, Cámara Trasera, Estantes',

    'portfolio.unit.16ft.name': 'Camión 16 ft',
    'portfolio.unit.16ft.desc': 'Camión de tamaño mediano perfecto para cargas medianas, mudanzas comerciales y rutas multi-parada.',
    'portfolio.unit.16ft.type': 'Camión 16 ft',
    'portfolio.unit.16ft.cargo': '900 cu ft',
    'portfolio.unit.16ft.payload': '5,000 lbs',
    'portfolio.unit.16ft.features': 'Plataforma, GPS, Rampa',

    'portfolio.unit.26ft.name': 'Camión 26 ft',
    'portfolio.unit.26ft.desc': 'Nuestro caballo de batalla — camiones de 26 pies para carga grande, logística contratada y operaciones de alto volumen.',
    'portfolio.unit.26ft.type': 'Camión 26 ft',
    'portfolio.unit.26ft.cargo': '1,800 cu ft',
    'portfolio.unit.26ft.payload': '10,000 lbs',
    'portfolio.unit.26ft.features': 'Plataforma, GPS, Clima Ctrl',
